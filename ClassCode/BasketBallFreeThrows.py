...
Players = ["KobeBryant", "JoeJohnson", "LeBronJames", "CarmeloAnthony",
           "DwightHoward", "ChrisBosh", "ChrisPaul", "KevinDurant", "DerrickRose", "DwayneWade"]
...
DerrickRose_Salary = [0, 0, 0, 4822800, 5184480,
                      5546160, 6993708, 16402500, 17632688, 18862875]
...
CarmeloAnthony_MP = [2941, 2486, 2806, 2277,
                     2634, 2751, 1876, 2482, 2982, 1428]
...
CarmeloAnthony_FGA = [1572, 1453, 1481,
                      1207, 1502, 1503, 1025, 1489, 1643, 806]
...
FreeThrow = np.array([KobeBryant_FT, JoeJohnson_FT, LeBronJames_FT, CarmeloAnthony_FT,
...
FreeThrowAttempts = np.array([KobeBryant_FTA, JoeJohnson_FTA, LeBronJames_FTA, CarmeloAnthony_FTA,
